...
lt-expand $2 | grep -v REGEX | grep -v '<prn><enc>' | sed 's/:>:/%/g' | grep -v ':<:' | sed 's/:/%/g' | cut -f2 -d'%' |  sed 's/^/^/g' | sed 's/$/$ ^.<sent>$/g' | tee $TMPDIR/tmp_testvoc1.txt |\
        ...
        apertium-interchunk ../../oci-fra.t2ax  ../../oci-fra.t2ax.bin |\
        apertium-interchunk ../../apertium-oci-fra.oci-fra.t2bx  ../../oci-fra.t2bx.bin |\
        apertium-interchunk ../../oci-fra.t2cx  ../../oci-fra.t2cx.bin |\
        ...
        apertium-transfer -n ../../oci-fra.t4x  ../../oci-fra.t4x.bin |\
...
lt-expand $2 | grep -v REGEX | grep -v '<prn><enc>' | sed 's/:>:/%/g' | grep -v ':<:' | sed 's/:/%/g' | cut -f2 -d'%' |  sed 's/^/^/g' | sed 's/$/$ ^.<sent>$/g' | tee $TMPDIR/tmp_testvoc1.txt |\
        ...
        lrx-proc -m ../../oci@gascon-fra.autolex.bin |\
        apertium-transfer -b ../../oci@gascon-fra.t1x  ../../oci@gascon-fra.t1x.bin |\
        apertium-interchunk ../../oci@gascon-fra.t2ax  ../../oci@gascon-fra.t2ax.bin |\
        apertium-interchunk ../../apertium-oci-fra.oci-fra.t2bx  ../../oci-fra.t2bx.bin |\
        apertium-interchunk ../../oci@gascon-fra.t2cx  ../../oci@gascon-fra.t2cx.bin |\
        apertium-interchunk ../../apertium-oci-fra.oci-fra.t2dx  ../../oci-fra.t2dx.bin |\
        apertium-postchunk ../../apertium-oci-fra.oci-fra.t3x  ../../oci-fra.t3x.bin |\
        apertium-transfer -n ../../oci@gascon-fra.t4x  ../../oci@gascon-fra.t4x.bin |\
	tee $TMPDIR/tmp_testvoc2.txt |\
        lt-proc -d ../../oci-fra.autogen.bin > $TMPDIR/tmp_testvoc3.txt
paste -d _ $TMPDIR/tmp_testvoc1.txt $TMPDIR/tmp_testvoc2.txt $TMPDIR/tmp_testvoc3.txt | sed 's/\^.<sent>\$//g' | sed 's/_/   --------->  /g' | grep -v '\^@'
...
lt-expand $2 | grep -v REGEX | grep -v '<prn><enc>' | sed 's/:>:/%/g' | grep -v ':<:' | sed 's/:/%/g' | cut -f2 -d'%' |  sed 's/^/^/g' | sed 's/$/$ ^.<sent>$/g' | tee $TMPDIR/tmp_testvoc1.txt |\
        ...
        apertium-interchunk ../../fra-oci.t2x  ../../fra-oci.t2x.bin  |\
