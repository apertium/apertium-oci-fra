...
bash inconsistency.sh fra-oci_gascon ../../../apertium-fra/.deps/fra.dix > /tmp/fra-oci_gascon.testvoc; bash inconsistency-summary.sh /tmp/fra-oci_gascon.testvoc fra-oci
echo ""
...
bash inconsistency.sh oci_gascon-fra ../../../apertium-oci/.deps/oci@gascon.dix > /tmp/oci_gascon-fra.testvoc; bash inconsistency-summary.sh /tmp/oci_gascon-fra.testvoc oci-fra
